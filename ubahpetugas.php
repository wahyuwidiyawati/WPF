  ...
  <body class=""> 
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">Ubah Petugas</h1>
        </div>
		...
		<form method="POST" action="petugaskeuangan.php">
			<tr for="nama">
				<td>Nama</td>
			...
			<tr for="jabatan">
				...
				<td>&nbsp;&nbsp;<input type="text" name="nip" maxlength="30" size="40"  placeholder="Masukkan jabatan"></td>
			</tr>
