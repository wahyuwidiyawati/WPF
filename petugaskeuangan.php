  ...
  <body class=""> 
    ...
    <div class="content">
        ...
        <div class="header">
            ...
            <h1 class="page-title">PETUGAS KEUANGAN</h1>
        </div>
		...
		<table width="250" border="5" align="center">
			<td>
			<ul>
				<font color="white" size="4" face="Times New Roman">Nama : Sari Patmi wahyuni</font><br>
				<font color="white" size="4" face="Times New Roman">Jabatan Komisi : KPPW</font><br><br>
